package com.reactive.patterns.ReactivePatterns.sec06.controller;

import com.reactive.patterns.ReactivePatterns.sec06.dto.ProductAggregate;
import com.reactive.patterns.ReactivePatterns.sec06.service.ProductAggregatorService;
...
public class ProductAggregateController {
    ...
    @GetMapping(value = "sec06/product/{id}",produces = {MediaType.APPLICATION_JSON_VALUE})
