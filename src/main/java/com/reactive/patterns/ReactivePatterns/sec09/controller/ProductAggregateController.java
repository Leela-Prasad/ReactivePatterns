...
import com.reactive.patterns.ReactivePatterns.sec09.service.ProductAggregatorService;
...
public class ProductAggregateController {
    ...
    @GetMapping(value = "sec09/product/{id}",produces = {MediaType.APPLICATION_JSON_VALUE})
